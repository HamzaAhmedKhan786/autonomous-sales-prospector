...
export function ProspectWorkspace() {
  ...
  return <main>
    <nav className="nav shell"><a className="brand brand-logo" href="#top" aria-label="Autonomous Sales Prospector home"><Image src="/brand/asp-logo.png" alt="Autonomous Sales Prospector" width={842} height={410} priority /></a><div className="nav-actions"><a href="/how-it-works">How it works</a><a href={process.env.NEXT_PUBLIC_CRM_APP_URL || "http://localhost:4100"}>Orbit CRM</a><span className="pilot-badge"><i /> Local MVP</span></div></nav>
    <WorkspaceTools />
    ...
    <section className="principles shell"><div><span>01</span><h3>Evidence first</h3><p>Every hook traces back to a source, so relevance is easy to verify.</p></div><div><span>02</span><h3>No black-box sending</h3><p>You review, edit, and decide what leaves the workspace.</p></div><div><span>03</span><h3>Built for signal, not volume</h3><p>One thoughtful message beats a hundred generic sequences.</p></div></section><footer className="shell product-footer"><div><b>Autonomous Sales Prospector</b><span>Product of HSK-Group · © 2026 HSK-Group · v1.0.0</span></div><nav aria-label="Product links"><a href="/how-it-works">How it works</a><a href="/support">Complaints & issues</a><a href="/license">License</a></nav></footer>
  </main>;
}
